...
#' hf <- load_hunter_folder() # Will return an empty object, you need a results object
...
#' @importFrom utils write.table
#' @examples
#' # Use a @functional_hunter or @multienricher result object to create real files
...
write_enrich_files <- function(func_results, output_files=getwd()){
	...
	fortify.compareClusterResult <- privateFun("enrichplot", "fortify.compareClusterResult")
