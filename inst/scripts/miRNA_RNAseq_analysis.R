...
option_list <- list(
	...
	optparse::make_option(c("-d", "--databases"), type="character", default="targetscan,mirdb,diana_microt,elmmo,microcosm,miranda,pictar,pita",
	...
	optparse::make_option(c("-u", "--unmaintained_filter"), type="double", default=1,
    	help="Minimun predicted and unmaintained databases that must support a pair. Default=%default"),
