...
pp <- ggplot2::ggplot(all_strategies, ggplot2::aes(x = strategy, y = correlation, fill = strategy)) +
  ggplot2::geom_violin(trim = FALSE, scale = "width") + ggplot2::ylim(-1.000001, min + 0.00001) +
...
cat("\n\nThis plot shows the distributions of correlation P values between RNAseq and miRNAseq using diferent strategies.
  \n")
pp <- ggplot2::ggplot(all_strategies, ggplot2::aes(x = strategy, y = pval, fill = strategy)) +
  ggplot2::geom_violin(trim = FALSE, scale = "width") + ggplot2::ylim(-0.0001, 0.2) +
  ggplot2::geom_boxplot(width=0.05)+
  ggplot2::theme(axis.text.x = ggplot2::element_blank(), axis.title.x = ggplot2::element_blank()) 
pp
...
```{r render_partial_reports, echo = FALSE, warning = FALSE, eval = FALSE}
  # curr_out <- ""
