...
```{r fisher, echo=FALSE, results = 'asis', warning = FALSE, message = FALSE, eval = !specific_evaluation}
cat("
...
```{r fisher_scatter, echo=FALSE, results = 'asis', warning = FALSE, message = FALSE, eval = !specific_evaluation}
...
```{r fisher_table, echo=FALSE, results = 'asis', warning = FALSE, message = FALSE, eval = !specific_evaluation}
cat("
