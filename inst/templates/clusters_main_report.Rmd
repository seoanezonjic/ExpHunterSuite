...
# Obtains genes info
cls_counts <- plyr::ddply(DEGH_results, plyr::.(DEGH_results$genes_tag,DEGH_results$Cluster_ID), nrow)
...
invisible(lapply(names(executed)[which(unlist(executed))],function(mod){
	invisible(lapply(rownames(cls_genes_summary),function(cl){
		if(!is.na(cl)){
			if(exists("enrichments_ORA")) cls_genes_summary[cl,paste(mod,"(ORA)")] <<- length(which(grepl(paste0("^",cl),ggplot2::fortify(enrichments_ORA[[mod]])$Cluster)))
			if(exists("enrichments_GSEA")) cls_genes_summary[cl,paste(mod,"(GSEA)")] <<- length(which(grepl(paste0("^",cl),enrichments_GSEA[[mod]]@compareClusterResult$Cluster)))
...
# Render
DT::datatable(cls_genes_summary, filter = 'top', rownames = FALSE, extensions = c('Buttons','ColReorder'),
                    options = list(
                    	colReorder = TRUE,
                    	dom = 'lftBip',
                        buttons = c('copy', 'csv', 'excel')
...
DEgenesHunter:::plot_enrResult_DT(enrichments_ORA$KEGG)
...
cat(length(DEgenesHunter:::get_categories(enrichments_ORA$KEGG)))
pp <- enrichplot::dotplot(enrichments_ORA$KEGG, showCategory=n_category) 
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$KEGG),DEgenesHunter:::calc_width(enrichments_ORA$KEGG))
...
pp <- DEgenesHunter:::clusters_heatplot(enrichments_ORA$KEGG@compareClusterResult)  
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$KEGG),DEgenesHunter:::calc_width(enrichments_ORA$KEGG))
...
pp <- enrichplot::emapplot(enrichments_ORA$KEGG, showCategory=n_category,pie="count", pie_scale=1.5, layout="kk")
DEgenesHunter:::plot_in_div(pp, fig_width = DEgenesHunter:::calc_width(enrichments_ORA$KEGG))
# cat(
# 	"**CNetplot**\n\n", 
# 	"WRITE THIS TEXT >>>>.\n\n"
# )
...
DEgenesHunter:::plot_enrResult_DT(enrichments_ORA$REACT)
...
cat(length(DEgenesHunter:::get_categories(enrichments_ORA$REACT)))

pp <- enrichplot::dotplot(enrichments_ORA$REACT, showCategory=n_category)  
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$REACT), DEgenesHunter:::calc_width(enrichments_ORA$REACT))
...
pp <- DEgenesHunter:::clusters_heatplot(enrichments_ORA$REACT@compareClusterResult)  
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$REACT), DEgenesHunter:::calc_width(enrichments_ORA$REACT))
...
pp <- enrichplot::emapplot(enrichments_ORA$REACT, showCategory=n_category,pie="count", pie_scale=1.5, layout="kk")
DEgenesHunter:::plot_in_div(pp, fig_width = DEgenesHunter:::calc_width(enrichments_ORA$REACT))
# cat(
# 	"**CNetplot**\n\n", 
# 	"WRITE THIS TEXT >>>>.\n\n"
# )
...
DEgenesHunter:::plot_enrResult_DT(enrichments_ORA$GO_BP)
...
cat(length(unique(DEgenesHunter:::get_categories(enrichments_ORA$GO_BP, showCategory = n_category))))

pp <- enrichplot::dotplot(enrichments_ORA$GO_BP, showCategory=n_category)  
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$GO_BP, showCategory=n_category), DEgenesHunter:::calc_width(enrichments_ORA$GO_BP))
...
pp <- DEgenesHunter:::clusters_heatplot(enrichments_ORA$REACT@compareClusterResult) 
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$GO_BP), DEgenesHunter:::calc_width(enrichments_ORA$GO_BP))

cat('\n\n**Enrich Map plot**\n\n', 
	'WRITE THIS TEXT >>>>.\n\n'
)
pp <- enrichplot::emapplot(enrichments_ORA$GO_BP, showCategory=n_category,pie="count", pie_scale=1.5, layout="kk")
DEgenesHunter:::plot_in_div(pp, fig_width = DEgenesHunter:::calc_width(enrichments_ORA$GO_BP))
# cat(
# 	"**CNetplot**\n\n", 
# 	"WRITE THIS TEXT >>>>.\n\n"
# )
...
DEgenesHunter:::plot_enrResult_DT(enrichments_ORA$GO_MF)
...
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$GO_MF), DEgenesHunter:::calc_width(enrichments_ORA$GO_MF))
...
pp <- DEgenesHunter:::clusters_heatplot(enrichments_ORA$GO_MF@compareClusterResult) 
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$GO_MF), DEgenesHunter:::calc_width(enrichments_ORA$GO_MF))
...
pp <- enrichplot::emapplot(enrichments_ORA$GO_MF, showCategory=n_category,pie="count", pie_scale=1.5, layout="kk")
DEgenesHunter:::plot_in_div(pp, fig_width = DEgenesHunter:::calc_width(enrichments_ORA$GO_MF))
# cat(
# 	"**CNetplot**\n\n", 
# 	"WRITE THIS TEXT >>>>.\n\n"
# )
...
DEgenesHunter:::plot_enrResult_DT(enrichments_ORA$GO_CC)
...
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$GO_CC), DEgenesHunter:::calc_width(enrichments_ORA$GO_CC))
...
pp <- DEgenesHunter:::clusters_heatplot(enrichments_ORA$GO_CC@compareClusterResult) 
pp <- DEgenesHunter:::set_standard_size(pp)
DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(enrichments_ORA$GO_CC), DEgenesHunter:::calc_width(enrichments_ORA$GO_CC))
...
pp <- enrichplot::emapplot(enrichments_ORA$GO_CC, showCategory=n_category,pie="count", pie_scale=1.5, layout="kk")
DEgenesHunter:::plot_in_div(pp, fig_width = DEgenesHunter:::calc_width(enrichments_ORA$GO_CC))
...
invisible(lapply(seq_along(custom_cls_ORA),function(i){
	...
	if(is.null(res)){
		...
		body <- "res <- custom_cls_ORA[[{{i}}]]
				...
				DEgenesHunter:::plot_enrResult_DT(res)
				...
				pp <- DEgenesHunter:::set_standard_size(pp)
				DEgenesHunter:::plot_in_div( pp, DEgenesHunter:::calc_height(res), DEgenesHunter:::calc_width(res))
				...
				pp <- DEgenesHunter:::clusters_heatplot(res@compareClusterResult) 
				pp <- DEgenesHunter:::set_standard_size(pp)
				DEgenesHunter:::plot_in_div(pp, DEgenesHunter:::calc_height(res), DEgenesHunter:::calc_width(res))
				...
				pp <- enrichplot::emapplot(res, showCategory=n_category,pie='count', pie_scale=1.5, layout='kk')
				DEgenesHunter:::plot_in_div(pp, fig_width = DEgenesHunter:::calc_width(res))
		"
