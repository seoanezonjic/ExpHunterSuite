...
```{r "{{method_name}}_cor_miRNA_table", echo = FALSE, message=FALSE, warning=FALSE}
...
utils::write.table(strat_data, file = file.path(outdir, "target_results_table.txt"), quote=FALSE, col.names=TRUE, row.names = FALSE, sep="\t")
