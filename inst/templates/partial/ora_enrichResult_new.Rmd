...
if(length(get_categories(enrichment_results))>2){ # Needs, at least, two categories
	# Main label 
	save(enrichment_results, file = "/mnt/scratch/users/bio_267_uma/josecordoba/claudia_prot/unique_prots/get_cdf_table.rb_0000/test.Rdata")
	...
	save(enrichment_results, file = "test.RData")
	cat("\n\n**Enrich Map plot**\n\n", 
