...
if (any(DE_all_genes$combined_FDR[!is.na(DE_all_genes$combined_FDR)] == 0)){
	min_FDR <- min(DE_all_genes$combined_FDR[DE_all_genes$combined_FDR != 0 & !is.na(DE_all_genes$combined_FDR)])
	DE_all_genes[DE_all_genes$combined_FDR == 0 & !is.na(DE_all_genes$combined_FDR),] <- min_FDR
}
