...
if(nrow(raw_filter) < 2000 || (rowSums(raw_filter) / ncol(raw_filter) > 5) < 1000  ) {
...
if (any(volcano_DE_all_genes$combined_FDR[!is.na(volcano_DE_all_genes$combined_FDR)] == 0)){
	min_FDR <- min(volcano_DE_all_genes$combined_FDR[volcano_DE_all_genes$combined_FDR != 0 & !is.na(volcano_DE_all_genes$combined_FDR)])
	volcano_DE_all_genes[volcano_DE_all_genes$combined_FDR == 0 & !is.na(volcano_DE_all_genes$combined_FDR),] <- min_FDR
}
