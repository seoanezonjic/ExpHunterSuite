...
```{r coverage_plot, echo = FALSE, warning = FALSE}
    ...
    ggplot2::ggplot(coverage_dt, ggplot2::aes(x = count_rank, y = total_counts)) +
        ggplot2::geom_point(size = 3) +
...
```{r coverage_plot_frac, eval = !is.null(coverage_dt$counted_frac),  echo = FALSE, warning = FALSE}
    ggplot2::ggplot(coverage_dt, ggplot2::aes(x = count_rank, y = counted_frac)) +
        ggplot2::geom_point(size = 3) +
        cowplot::theme_cowplot() +
        cowplot::background_grid() +
        ...
        ggplot2::ylim(c(0,NA)) +
        ggplot2::scale_color_brewer(palette="Dark2") +
        ggplot2::ggtitle("% counts read sorted by rank")
```
