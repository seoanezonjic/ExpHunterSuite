...
if("DEgenesHunter" %in% (.packages())){ # Package mode, load private functions
	exists_graph_file <- DEgenesHunter:::exists_graph_file
	exists_enrich_df <- DEgenesHunter:::exists_enrich_df
	check_results <- DEgenesHunter:::check_results
	set_default_width <- DEgenesHunter:::set_default_width
	plot_in_div <- DEgenesHunter:::plot_in_div
	get_genes <- DEgenesHunter:::get_genes
	check_categories <- DEgenesHunter:::check_categories
