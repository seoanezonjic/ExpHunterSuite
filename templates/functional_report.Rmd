...
# Message
cat(paste(c("Table of signifcant genes taking into account variables showd into table. 15Top of best (",nrow(topgenes)," items) and worst (",nrow(botgenes)," items) are being shown in two different tables"), collapse = ""))
```
```{r render_topgenes, echo = FALSE, eval = exists("DEG_annot_table_Symbol")}
# Render
knitr::kable(topgenes)
```
```{r render_botgenes, echo = FALSE, eval = exists("DEG_annot_table_Symbol")}
# Render
