...
enrich_ora_symb <- setReadable(enrich_ora, OrgDb = current_organism_info$Bioconductor_DB[1], keyType="ENTREZID")
...
enrich_gsea_symb <- setReadable(enrich_gsea, OrgDb = current_organism_info$Bioconductor_DB[1], keyType="ENTREZID")
...
invisible(lapply(names(go_main_enrich),function(onto){
	...
	if(go_flags[[paste0("perform_gsea_go_",onto)]]){
		...
		enrich_go_gsea_symb <- setReadable(enrich_go_gsea[[onto]], OrgDb = current_organism_info$Bioconductor_DB[1], keyType="ENTREZID")
...
if(go_flags$enrich_go_gsea){
	...
	enr_go_gsea_symb <- setReadable(enr_go_gsea, OrgDb = current_organism_info$Bioconductor_DB[1], keyType="ENTREZID")
...
enrich_react_gsea_symb <- setReadable(enrich_react_gsea, OrgDb = current_organism_info$Bioconductor_DB[1], keyType="ENTREZID")
