...
```{r setup_plots, echo=FALSE, results='asis', eval=kegg_flags$KEGG_SECTION}
if(kegg_flags[["enrich_ora"]] | kegg_flags[["enrich_gsea"]] | go_flags[["enrich_go"]] | go_flags[["enrich_go_gsea"]]){
