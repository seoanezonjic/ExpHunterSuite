...
# Take targets
topgenes <- DEG_annot_table_Symbol[topindx,c("Symbol",targetcols,colnames(DEG_annot_table_Symbol)[1])]
botgenes <- DEG_annot_table_Symbol[botindx,c("Symbol",targetcols,colnames(DEG_annot_table_Symbol)[1])]
# Sort
