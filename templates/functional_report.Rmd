...
# for(onto in names(enrich_go)){
	...
	if(nrow(enrich_go_gsea[[onto]]@result) > 0){
		...
		cat("<br>**Plot Name**<br>Plot text")
		go_pp <- gseaplot2(enrich_go_gsea[[onto]], geneSetID=ifelse(nrow(enrich_go_gsea[[onto]]@result) < 4, seq(nrow(enrich_go_gsea[[onto]]@result)), 1:4), title = enrich_go_gsea[[onto]]$Description[1], pvalue_table = TRUE) 
		print(go_pp)
...
if(go_flags$enrich_go){
	...
	# Plot
	cat("<br>**Plot Name**<br>Plot text")
	go_pp  <- barplot(enr_go)
	print(go_pp)
	cat("<br>**Plot Name**<br>Plot text")
	go_pp  <- dotplot(enr_go, showCategory=30)
	print(go_pp)
	cat("<br>**Plot Name**<br>Plot text")
	go_pp  <- cnetplot(enr_go, showCategory = 15)
	print(go_pp)
	cat("<br>**Plot Name**<br>Plot text")
	go_pp  <- emapplot(enr_go, showCategory = 50)
	print(go_pp)
	cat("<br>**Plot Name**<br>Plot text")
	go_pp  <- heatplot(enr_go)
	print(go_pp)
	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- upsetplot(enr_go)
	print(go_pp)
...
if(go_flags$enrich_go_gsea){
	...
	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- cnetplot(enr_go_gsea)
	print(go_pp)

	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- emapplot(enr_go_gsea)
	print(go_pp)

	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- heatplot(enr_go_gsea)
	print(go_pp)

	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- ridgeplot(enr_go_gsea)
	print(go_pp)

	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- gseaplot2(enr_go_gsea, geneSetID=ifelse(nrow(enr_go_gsea@result) < 4, seq(nrow(enr_go_gsea@result)), 1:4), title = enr_go_gsea$Description[1], pvalue_table = TRUE) 
	print(go_pp)

	cat("<br>**Plot Name**<br>Plot text")
	go_pp <- gsearank(enr_go_gsea, geneSetID=1, title = enr_go_gsea$Description[1])
	print(go_pp)
	cat("\n \n")
}
