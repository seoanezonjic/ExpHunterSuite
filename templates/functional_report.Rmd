...
```{r table_top_genes, echo = FALSE, eval = flags$Clustered, results = 'asis'}
...
```
```{r render_topgenes, echo = FALSE, eval = flags$Clustered, results = 'asis'}
cat("\n### **Top positive**\n")
# Render
...
```
```{r render_botgenes, echo = FALSE, eval = flags$Clustered, results = 'asis'}
cat("\n### **Top negative**\n")
# Render
