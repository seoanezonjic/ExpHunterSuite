...
chart.Correlation(raw_filter[index_control_cols], histogram=TRUE, pch=19, log="xy")
chart.Correlation(raw_filter[index_treatmn_cols], histogram=TRUE, pch=19, log="xy")

chart.Correlation(raw_filter, histogram=TRUE, pch=19, log="xy")
```
