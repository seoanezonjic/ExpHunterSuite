...
```{r DESeq2_only_prev_norm_plot, echo = FALSE, fig.height=12, fig.width=12}

	prevalent_genes_check <- DE_all_genes[, "genes_tag"] %in% c("PREVALENT_DEG")
	DE_prevalent_genes <- rownames(DE_all_genes[prevalent_genes_check,])
