...
cat("In total there were ", max(unique(results_WGCNA$gene_cluster_info$MM_Cluster_ID)) , "clusters. 
...
```{r WGCNA_conditional_block_plot_cluster_membership, eval=grepl("W", opt$modules), echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=15}
	genes_per_cluster <- table(results_WGCNA$gene_cluster_info$MM_Cluster_ID)
...
The first plot shows the correlation between clusters and factors directly. The second plot clusters these clusters along with the factors. 
