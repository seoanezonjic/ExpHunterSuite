...
cat("### **Eigen values clustering**	

The second plot clusters these eigengenes along with the factors.") 
...
cat("TEST GRAPH: DENDOGRAN USING SAME OPTIONS AS WGCNA DEFAULTS")
    ...
    #plot(clust, sub="", xlab="", ylab="", ylim=c(0,1))
	plot_in_div(plot(clust, sub="", xlab="", ylab="", ylim=c(0,1)),
	fig_width= 4+ calc_width_clusters((features_count + cluster_count), multiplier = 0.15),  min_size = 5)

cat("TEST GRAPH: DENDOGRAN USING ABSOLUTE CORRELATION VALUES TO BUILD DISTANCE MATRIX")
